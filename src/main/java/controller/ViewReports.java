...
/**
 * The ViewReports class manages the report tables of the application.
 */
public class ViewReports {
    ...
    public ViewReports() throws SQLException {
    }
...
//    }
    ...
    /**
     * Initializes the ViewReports populating the tables and combo boxes.
    ...
    public void loadApByContactTable() throws SQLException {
        ...
        apStartRp.setCellValueFactory(new PropertyValueFactory<>("apPrettyStart"));
        apEndRp.setCellValueFactory(new PropertyValueFactory<>("apPrettyEnd"));
    ...
    public ObservableList<totalsReport> customersByCountryList() throws SQLException {
        ...
        //List of ViewCustomers to count from
    ...
    public ObservableList<totalsReport> appointmentsByTypeList() throws SQLException {
        ...
        //List of totals to be returned after totals are added
        ObservableList<totalsReport> reportList = FXCollections.observableArrayList();
        //List of ViewAppointments to count from
